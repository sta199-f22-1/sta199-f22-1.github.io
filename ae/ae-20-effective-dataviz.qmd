...
-   **Your turn (10 minutes):** Recreate the visualization above.
    Try to match as many of the elements as possible.
    Hint: You might need to reshape your data first.
...
-   **Question:** What is wrong with the x-axis of the plot above?
    How can you fix it?
